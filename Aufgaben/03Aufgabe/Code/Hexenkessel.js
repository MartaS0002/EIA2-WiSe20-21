...
(function (L03_Hexenkessel) {
    ...
    function handleInfo(_event) {
        ...
        let gras = (document.querySelector("#flussgras"));
        let schuppen = (document.querySelector("#schlangenschuppen"));
        let einhornblut = (document.querySelector("#einhornblut"));
        let heat = (document.querySelector("#heat"));
        let cool = (document.querySelector("#cool"));
        let intensity = false;
        let rezept = (document.querySelector("#result"));
        rezept.innerHTML = "";
        ...
        for (let entry of formData) {
            switch (entry[0]) {
                ...
                case "Zutat":
                    if (entry[1] != "")
                        rezept.innerHTML += "Zutat: " + entry[1] + "<br>";
                    break;
                case "Spinnen Menge":
